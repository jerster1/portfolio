...
def display_mexport(addr, data, libname):
	...
	print("--------------------------------------------------------------------")
	print("- Module Export: {} 0x{} -").fomart(libname, addr)
	print(m)
	print("--------------------------------------------------------------------")
...
def display_mimport(addr, data, libname):
	...
	if (addr & 0xE0000000) == 0xE0000000:
		...
		print("--------------------------------------------------------------------")
		print("- Module Import (Small): {} 0x{} -".format(libname, addr)
		print(m)
		print("--------------------------------------------------------------------")
	else:
		...
		print("--------------------------------------------------------------------")
		print("- Module Import: {} 0x{} -").format(libname, addr)
		print(m)
		print("--------------------------------------------------------------------")  
...
def dump_data(data, file_name):
	if not os.path.exists(DUMP_PATH):CS_MODE_BIG_ENDIAN
